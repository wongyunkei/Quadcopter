...
void EncoderUpdate(){
	App::mApp->mEncoder1->Update(MathTools::DegreeToRadian(-30));
	App::mApp->mEncoder2->Update(MathTools::DegreeToRadian(-60));
	App::mApp->mEncoder3->Update(MathTools::DegreeToRadian(-60));
}
